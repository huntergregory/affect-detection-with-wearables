...
binned_residuals_vs_x = function(model, model_description, column, xlab, do_stride=FALSE) {
  x = get_train_data(do_stride)[column]
  predictions = get_predictions(model)
...
# show_binned_residuals(model, 'Simple Chest and Wrist Model')
# par(mfrow=c(3,2))
# show_binned_residuals(model, 'Simple Chest and Wrist Model', 'wrist_ACC_magnitude_mean', 'Mean Wrist ACC magnitude', DO_STRIDE)
# ...
```
